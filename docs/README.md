# docs/ — el rastro escrito del proyecto

Esta carpeta la escribe el agente durante las fases. Aquí acaban:

- `INVENTARIO.md` — lo que no se puede perder (fase 1), con su sección
...
la memoria del proyecto, y lo que permite que cualquier sesión futura continúe
el trabajo sin perder contexto.
